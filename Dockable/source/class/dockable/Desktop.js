...
//            this.m_rects.forEach(function(r){
...
//                ctx.fillRect( left, y - layout.HandleSize/2, width, layout.HandleSize);
        ...
        _onDesktopResize : function(e)
        {
            ...
            this.m_layout.recomputeForSize(bounds);
...
//        },
        ...
        _windowMovingDoneCB : function(win) {
            var rect = win.getUserData( "destinationRectangle");
            if( rect == null) return;

            win.setPositionRect( rect);
        },
        ...
        _windowMovingCB : function(win,e)
        {
            ...
            for( var id in this.m_rects) {
                var rect = this.m_rects[id];
                console.log(rect);
...
//                    win.setHeight( rect.height);
                    ...
                    win.setUserData( "destinationRectangle", rect);
                    return;
                }
            }
            win.setUserData( "destinationRectangle", null);
            return;
